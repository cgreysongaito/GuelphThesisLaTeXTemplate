...
%Referencing
%Change options to set reference style (e.g. citestyle=ele, bibstyle=ele)
%Change options to set the backend and encoding (e.g. backend=biber, bibencoding=utf8)
\usepackage[<options>]{biblatex}
\addbibresource{<library.bib>}
\newcommand\posscite[1]{\citeauthor{#1}'s (\citeyear{#1})} %Allows the use of possessive in sentence citations
...
%If you want a single bibliography at the end of the whole thesis use the code below.
